...
const getInputValue = (id) =>
{
  ...
  const converted = parseFloat(element); // ParseInt to ParseFloat
  return converted;
};
...
const updatePrice = (id, value) =>
{
  ...
  document.getElementById(id).innerText = total.toFixed(2); //After Point added two number
};
...
const updateTotal = () =>
{
  ...
  document.getElementById("total").innerText = grandTotal.toFixed(2);//After Point added two number 
};
loadProducts();